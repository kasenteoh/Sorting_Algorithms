...
src/FHsort.java
    - Contains sorting algorithms. Particularly quick sort which is utilized in this assignment

src/TestClass.java
    - Creates arrays of different sizes
    - Tests the run time of quick sort
    - Contains the main application to run the program
